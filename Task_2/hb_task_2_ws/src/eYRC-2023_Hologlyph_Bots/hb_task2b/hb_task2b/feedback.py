...
class ArUcoDetector(Node):
    ...
    def __init__(self):
        ...
        self.publisher_bot_1 = self.create_publisher(Pose2D, '/hb_bot_1/pose', 10)
        self.publisher_bot_2 = self.create_publisher(Pose2D, '/hb_bot_2/pose', 10)
        self.publisher_bot_3 = self.create_publisher(Pose2D, '/hb_bot_3/pose', 10)
        ...
        try:
            ...
            for i,j in zip(corners, ids):
                ...
                if j[0] == 1:
                    ...
                    self.publisher_bot_1.publish(msg)
                ...
                if j[0] == 2:
                    ...
                    msg.y = float(average_y)
                    msg.theta = float(current_theta)
                    self.publisher_bot_2.publish(msg)
                ...
                if j[0] == 3:
                    ...
                    msg.y = float(average_y)
                    msg.theta = float(current_theta)
                    self.publisher_bot_3.publish(msg)
